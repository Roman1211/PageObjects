...
public class ItemPage extends Page{
    ...
    public void addItem(){
        int oldQuantity = Integer.parseInt(quantity.getText());
        addButton.click();
        wait.until((WebDriver driver) -> Integer.parseInt(quantity.getText()) - oldQuantity == 1);             // ожидание обновления корзины
    }
